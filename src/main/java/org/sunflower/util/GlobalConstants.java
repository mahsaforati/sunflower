...
{
	private static final String SYSTEM_PROPERTY_CONF_PATH = "sunflower.conf.path";

	public static ConfigContainer getConfig()
	{
		String defaultConfPath = "/Users/Mahsa/IdeaProjects/sunflower/src/main/java/org/sunflower/util/sunflower.conf";
		ConfigContainer conf;
		String path = System.getProperty(SYSTEM_PROPERTY_CONF_PATH);
		if(path != null)
		{
			conf = new ConfigContainer(path, null);
		}
		else
		{
			conf = new ConfigContainer(defaultConfPath, null);
		}
		return conf;
	}
}
