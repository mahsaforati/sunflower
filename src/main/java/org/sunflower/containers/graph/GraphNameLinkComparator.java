...
public class GraphNameLinkComparator implements Comparator<GraphNameLink>
{

	@Override
	public int compare(GraphNameLink a, GraphNameLink b)
	{
		double result = b.getStrength() - a.getStrength();
		if(result == 0)
		{
			return 0;
		}
